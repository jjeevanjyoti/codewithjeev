            ...
            <div className="row no-padding about-row" >
                ...
                <div className="col-sm-8 about_info">
                    ...
                    <Jumbotron fluid className="Desc_Jumbo">
                        <Container>
                            <p className="roboto">I am a <strong>Full-stack Developer</strong> from Bangalore, India. I am very passionate and dedicated to my work. I have 2.2 years  work experience. And enjoy working in a team or individual.</p>
